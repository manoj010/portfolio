...
export const About = () => {
  return (
    <section id="about" className="py-24 md:py-48 bg-surface-container-low px-6">
      <div className="content-container grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">About My<span className="hidden md:inline"><br/></span> Development Mindset.</h2>
        </motion.div>
        ...
        <div className="md:col-span-8 flex flex-col gap-8">
          <motion.p 
            ...
            className="text-xl md:text-2xl leading-relaxed text-on-surface-variant font-light"
          >
          ...
          <motion.p 
            ...
            className="text-lg md:text-xl leading-relaxed text-on-surface-variant"
          >
